...
<html>
    ...
    <body>
        ...
        <div id="cuerpo">
            ...
            <h1><p align="center">Ha sucedido un error autentificando su usuario</p></h1><br>
            <h1><p align="center">Este servicio es unico para estudiantes de la U de A.</p></h1><br>
        </div>
        <script>
